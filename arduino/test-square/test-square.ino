...
void Timer_finish()  {
  ...
  wheelRightS = ((wheelSpeedR / 1450) * 2 * 3.14 * R);  //  * 1.0436 // 663  // метры L = 2*PI*R*n/N
  wheelLeftS  = ((wheelSpeedL / 1450) * 2 * 3.14 * R);  //  * 0.9564 //*
